/*******************************************************************************
 CT.............: CN_bosau-#[Table.component]#_Inclusao#[Table.module]#ErroTempParamVazia.p
 Data ..........: 05/06/2018
 Programador ...: Gerador de CRUD
 Objetivo ......: Caso de teste com o objetivo de validar o a falta de parametros para
                  #[Table.description]#
 Critério aceite: #[Table.description]# nao pode ser incluido
******************************************************************************/
...
procedure piExecute:
    ...
    then assign lPassed = yes.
                ...
                cText = "Nao foram realizadas as validacoes referentes ao preenchimento das tabelas de entrada.".
