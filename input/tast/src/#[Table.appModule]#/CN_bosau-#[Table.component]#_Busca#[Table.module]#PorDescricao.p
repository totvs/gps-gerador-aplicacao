/*******************************************************************************
 CT.............: CN_#[Table.controller]#_Busca#[Table.module]#PorDescricao.p
 Data ..........: 05/06/2018
 Programador ...: Gerador de CRUD
 Objetivo ......: Caso de teste com o objetivo de validar a consulta livre
...
procedure piExecute:
    ...
    define variable searchQuery as character no-undo.
...
#[endWhileFields]#
    ...
    assign searchQuery = string(#[inlineFields,isKey=true]##[IF,isFirst]##[Field.fieldName]#-aux#[endIF]##[endInlineFields]#).
    ...
    run get#[Table.module]#ByQuery in h-bosau-#[Table.component]#-aux(input startRow,
                                                                   input pageSize,
                                                                   input orderList,
                                                                   input searchQuery,
                                                                   output hasNext,
    ...
    if not can-find(first tmp#[Table.module]#)
    then do:
           assign lPassed = no
    ...
    for each tmp#[Table.module]# no-lock:
#[whileFields,fixedValue=]#
        #[IF,isFirst]#if #[endIF]##[IF,!isFirst]#and#[endIF]# tmp#[Table.module]#.#[Field.fieldName,MaxAttributeSize]# = #[Field.fieldName]#-aux
#[endWhileFields]#        
        then assign lg-achou-reg-aux = yes.
    end.
